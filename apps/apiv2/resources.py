...
#class PackageRootResource(ModelResource):
...
class PublicDataSerializer(Serializer):
    def serialize(self, obj):
        if isinstance(obj, User):
            return super(PublicDataSerializer, self).serialize(obj.username)
        else:
            return super(PublicDataSerializer, self).serialize(obj)

class PackageResource(ModelResource):
    model = Package
    exclude = ('usage',)
    related_serializer = PublicDataSerializer
...
#            pass
#        else:
#            return super(PackageResource, self).serialize_model(instance)
